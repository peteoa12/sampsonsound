...
gulp.task('welcome', (done) => {
	console.log(colors.red('Say goodbye to all of your subpar compiler problems!'));
	done();
});

// This task says make cool shit.
gulp.task('make-cool-stuff', (done) => {
	setTimeout(() => {
		console.log(' ');
		console.log(' ================================================ '.red);
		console.log('  Welcome to the new and improved compiler.         '.blue.bold);
		console.log("  You're good to go.                              ".blue.bold);
		console.log('  Make cool 💩.                                     '.blue.bold);
		console.log('                                - The Universe   '.blue.dim);
		console.log(' ================================================ '.red);
		console.log(' ');
		done();
	}, 500);
...
gulp.task('default', gulp.series('welcome', 'start-browsersync', 'build', 'watch', 'make-cool-stuff', 'version'));
...
gulp.task(
	'no-browser-sync',
	gulp.series('welcome', gulp.parallel('html-refresh', 'html-check', 'image-compress', 'js-compile', 'sass-compile'), 'make-cool-stuff', 'version')
);
